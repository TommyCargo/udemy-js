...
console.log('https://vk.com/catlog/' + 5);
...
// два плюса это бинарный оператор сложения и унарный плюс
console.log(typeof(parseInt('15px', 10)));

//let ans = +prompt("Hello?", '');
// унарный плюс превращает результат prompt в число
...
// && запинается на первой слева лжи и возвращает ее
// || запинается на первой слева правде и возвращает ее
